...
class Members extends CI_Controller {
	...
	function trx_pulsa_komplain(){
		cek_session_members();
		$row = $this->db->query("SELECT * FROM rb_pembelian_pulsa where id_pembelian_pulsa ='".cetak($this->input->post('id'))."' AND id_reseller='".$this->session->id_konsumen."'")->row_array();
		...
		$data = array(
			// 'trxid' => '156757', // Masukkan Transaksi ID
			'api_trxid' => $row['api_trxid'], // Atau Anda bisa menggunakan ID transaksi dari server Anda (pilih salah satu)
		);

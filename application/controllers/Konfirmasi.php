...
class Konfirmasi extends CI_Controller {
	...
	public function unotify_deposit(){
		if ($this->input->post('status')=='berhasil'){ $status_trx = 'Sukses'; }else{ $status_trx = 'Batal'; }
		$idp = $this->db->query("SELECT id_withdraw FROM rb_withdraw where keterangan='".cetak($this->input->post('trx_id'))."'")->row_array();

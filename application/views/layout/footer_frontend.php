...
<script data-cfasync="false" src="<?= base_url()?>asset/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="<?= base_url()?>asset/js/jquery-3.3.1.min.js"></script>
